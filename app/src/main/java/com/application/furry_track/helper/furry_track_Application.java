...
public class furry_track_Application extends Application {

    public static final String TAG = furry_track_Application.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static furry_track_Application mInstance;
    ...
    public static synchronized furry_track_Application getInstance() {
        return mInstance;
    }
