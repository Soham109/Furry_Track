...
import com.application.furry_track.Adapter.Adapter_Medicale_List;
...
public class Medicale_Fragment extends Fragment_Base_Fragment {
    ...
    public static Medicale_Fragment newInstance(String param1, String param2) {
        Medicale_Fragment fragment = new Medicale_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_medicale, container, false);
        init(view);
        return view;
    ...
    void init(View view) {
        ...
        flot_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentds = new Intent(getActivity().getApplicationContext(), Medicale_add_Activity.class);
    ...
    private void get_banner() {
        ...
        final ArrayList<f_medical_get_set> data_list_home = new ArrayList<>();
        dialog.setCancelable(false);
        dialog.show();
        try {
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, mcontext.getResources().getString(R.string.base_url) + "apiMedicalHistory/GetMedical?PetId=" + PET_ID, null, new Response.Listener<JSONObject>() {
                @Override
                    ...
                    try {
                        ...
                        if (jobj != null && jobj.getString("Success").equalsIgnoreCase("true")) {
                            ...
                            for (int i = 0; i < jArray_cat.length(); i++) {
                                ...
                                f_medical_get_set gift = new f_medical_get_set();
                                gift.MedicalId = json_data.getString("MedicalId");
                                gift.ConditionDescription = json_data.getString("ConditionDescription");
                                gift.MedicalImage = json_data.getString("MedicalImage");
                                gift.MedicalDate = json_data.getString("MedicalDate");
                                ...
                                gift.DOB = json_data.getString("DOB");
                            ...
                            final Adapter_Medicale_List mAdapterlist = new Adapter_Medicale_List(mcontext, data_list_home);
