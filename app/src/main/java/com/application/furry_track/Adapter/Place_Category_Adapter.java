...
import com.application.furry_track.get_set.place_to_visit_category_get_set;

import java.util.ArrayList;


@SuppressLint("ViewHolder")
public class Place_Category_Adapter extends RecyclerView.Adapter<Place_Category_Adapter.ViewHolder> {

    Activity context;
    ArrayList<place_to_visit_category_get_set> data = new ArrayList<>();
    ...
    public Place_Category_Adapter(Activity context, ArrayList<place_to_visit_category_get_set> arraylist) {
