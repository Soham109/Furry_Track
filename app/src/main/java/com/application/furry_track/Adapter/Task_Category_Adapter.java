...
import com.application.furry_track.get_set.Volunteer_Visit_Category_get_set;
...
public class Task_Category_Adapter extends RecyclerView.Adapter<Task_Category_Adapter.ViewHolder> {
    ...
    Activity context;
    ArrayList<Volunteer_Visit_Category_get_set> data = new ArrayList<>();
    ...
    public Task_Category_Adapter(Activity context, ArrayList<Volunteer_Visit_Category_get_set> arraylist) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.txt_v_no.setText(data.get(position).getCategoryName().replace("null", "") + " (" + data.get(position).getTotal().replace("null", "") + ")");
