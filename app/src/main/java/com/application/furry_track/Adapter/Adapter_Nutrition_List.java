...
public class Adapter_Nutrition_List extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    ArrayList<f_nutrition_get_set> data;
    ...
    public Adapter_Nutrition_List(Activity activity, ArrayList<f_nutrition_get_set> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.img_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentds = new Intent(context.getApplicationContext(), Nutrition_add_Activity.class);
                intentds.putExtra("pet_id", data.get(position).getPetId());
                intentds.putExtra("NutritionId", data.get(position).getNutritionId());
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    if (isNetworkAvailable()) {
                                        submit_api(data.get(position).getNutritionId());
